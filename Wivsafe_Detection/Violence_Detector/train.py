...
dataset_path = r'Wivsafe_Detection\Violence_Detector'
...
model.save(r'Wivsafe_Detection/Violence_Detector/violence_detection.keras')
...
# Save plot to disk
plt.savefig(r'Wivsafe_Detection/Violence_Detector/plot.png')
